...
Generates the clean, light-themed interactive HTML platform.
Completely removes any '$' dollar signs from all text, titles, labels, table headers, and axis titles.
"""
import json
import os
  ...
  <header>
    <div class="header-inner">
      <div class="header-titles">
        <h1>Interactive Specific Heat Capacity (Cp vs. T) Materials Database</h1>
  ...
  <div class="container">
    ...
    <div class="sidebar">
      ...
      <div class="card">
        ...
        <!-- Specific Heat Unit -->
        <div class="form-group">
          <label for="select-cpunit">Specific Heat (Cp) Unit:</label>
      ...
      <div class="chart-card">
        <div class="chart-header">
          <span style="font-size: 0.95rem; font-weight: 700; color: #111827;" id="chart-title">
            Specific Heat Capacity (Cp) vs. Temperature (T)
          </span>
      ...
      <div class="bottom-grid">
        ...
        <div class="card">
          ...
          <div class="form-group" style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
            <label style="margin: 0; white-space: nowrap;">At Reference Temperature (T):</label>
