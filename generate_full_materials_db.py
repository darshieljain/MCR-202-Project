...
def build_database():
    ...
    advanced = [
        ...
        ("adv_03", "Magnesium Diboride Superconductor", "MgB2", 45.93, "shomate", {"A": 48.120, "B": 22.450, "C": -7.850, "D": 1.150, "E": -1.050}, 250.0, 800.0, 42.10, "J/(mol*K)", "Nagamatsu et al., Nature / NIST", "Conventional phonon-mediated superconductor with record Tc = 39 K; Shomate valid 250-800 K."),
